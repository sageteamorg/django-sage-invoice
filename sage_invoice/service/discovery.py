...
class JinjaTemplateDiscovery:
    ...
    def discover(self):
        """
        Discovers model and receipt template files in the specified models directory
        and categorizes them into model_templates and receipt_templates dictionaries.
        """
    ...
    def get_template_path(self, template_choice, is_receipt=False):
        """
        Returns the template path based on the template choice and whether it is a receipt.
        """
        if is_receipt:
